...
// @WebMvcTest의 경우 JPA 기능이 작동하지 않기 때문에 Controller와 ControllerAdvice 등 외부 연동과 관련된 부분만 활성화된다.
// JPA 기능까지 한번에 테스트를 원할 때에는 @SpringBootTest와 TestRestTemplate을 사용하면 된다.
